...
public class TfMethodWeig implements Serializable {
    private String gene;
    ...
    public TfMethodWeig(String gene, String genemapper, String beta, String se, String te, String atac, String silencer, String promoter, String knock, String m_se, String m_te, String m_atac, String m_silencer, String m_promoter, String curate, String weight) {
        this.gene = gene;
        this.genemapper = genemapper;
        this.beta = beta;
        this.se = se;
